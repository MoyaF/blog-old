...
export const WORK_EXPERIENCE: WorkExperience = [
  ...
  },
  {
    company: "Ualá",
    role: "Software Engineer",
    technologies: ["Java", "AWS Lambda", "AWS SQS", "AWS SNS", "AWS Api Gateway"],
